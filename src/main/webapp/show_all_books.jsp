...
<head>
    ...
    <title>
        <s:if test="#search_nav!=null">Search</s:if>
        <s:if test="#category_nav!=null">Category</s:if>
    </title>
...
<div id="templatemo_container">
    ...
    <div id="templatemo_content">
        ...
        <div id="templatemo_content_right">
            <s:if test="#search_nav!=null">
                <h1>Search for : <s:property value="#search_nav"/></h1>
            </s:if>
            <s:if test="#category_nav!=null">
                <h1>Books of category : <s:property value="#category_nav"/></h1>
            </s:if>
